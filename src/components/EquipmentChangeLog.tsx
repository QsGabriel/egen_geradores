...
import { EquipmentChangeLog } from '../types';

const EquipmentChangeLogComponent: React.FC = () => {
  const { changeLogs } = useInventory();
  const [filteredLogs, setFilteredLogs] = useState<EquipmentChangeLog[]>([]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="animate-fade-in-up">
        ...
        <p className="text-gray-500 dark:text-gray-400">Registro de todas as modificações realizadas nos equipamentos</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Equipamento, usuário ou motivo..."
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">{log.equipmentName}</h3>
      ...
      {filteredLogs.length === 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-12 text-center border border-gray-100 dark:border-gray-700">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            {changeLogs.length === 0 
              ? 'Ainda não há registros de alterações de equipamentos.'
...
export default EquipmentChangeLogComponent;