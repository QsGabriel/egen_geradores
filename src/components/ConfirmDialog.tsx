...
const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  const getButtonStyles = () => {
    switch (type) {
      ...
      case 'info':
        return 'bg-egen-navy hover:bg-egen-navy/90 text-white shadow-lg shadow-egen-navy/25';
      default:
  ...
  const getIconColor = () => {
    switch (type) {
      ...
      case 'info': return 'text-egen-blue';
      ...
      <div className="bg-white dark:bg-egen-dark-surface rounded-2xl shadow-2xl max-w-md w-full animate-scale-in">
        <div className="px-6 py-5 border-b border-gray-100 dark:border-white/5 flex items-center justify-between">
          <div className="flex items-center">
            <div className={`p-2 rounded-full bg-gray-50 dark:bg-gray-700 mr-3 ${getIconColor()}`}>
