    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Filtrar por Motivo</label>
            <select
              value={filterReason}
          ...
          <div className="flex items-end">
            <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
              ...
              <span className="font-medium text-gray-700 dark:text-gray-300">{filteredMovements.length}</span>&nbsp;movimentação(ões) encontrada(s)
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Movements Table */}
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
